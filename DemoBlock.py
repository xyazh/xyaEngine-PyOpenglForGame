...
class DemoBlock:
    ...
    def addSurface(self, buf_builder: BufferBuilder):
        ...
        if not self.frontHasBlock():
            buf_builder.pos(self.x + 0.5, self.y + 0.5, self.z + 0.5).col(1, 0, 0, 1).end()
            buf_builder.pos(self.x - 0.5, self.y + 0.5, self.z + 0.5).col(0, 1, 0, 1).end()
            buf_builder.pos(self.x - 0.5, self.y - 0.5, self.z + 0.5).col(0, 0, 1, 1).end()
            buf_builder.pos(self.x + 0.5, self.y - 0.5, self.z + 0.5).col(1, 1, 0, 1).end()
        # 后
